...
RUN userhome=$(eval echo ~${DEVELOPER_USERNAME}) \
  ...
  && mkdir -p /workspaces/rails-api-getting-starte-gcp \
  && chown -R ${DEVELOPER_USERNAME}:${DEVELOPER_USERNAME} /workspaces/rails-api-getting-starte-gcp \
  && chown -R ${DEVELOPER_USERNAME}:${DEVELOPER_USERNAME} /usr/local/bundle/*

# Add the app's "bin/" directory to PATH:
ENV PATH=/workspaces/rails-api-getting-starte-gcp/bin:$PATH

# Set the app path as the working directory:
WORKDIR /workspaces/rails-api-getting-starte-gcp
...
COPY --chown=${DEVELOPER_USERNAME} Gemfile* /workspaces/rails-api-getting-starte-gcp/
...
COPY --from=testing /workspaces/rails-api-getting-starte-gcp/ /workspaces/rails-api-getting-starte-gcp/
...
RUN git config --global --add safe.directory /workspaces/rails-api-getting-starte-gcp
...
COPY --chown=${DEVELOPER_USERNAME} . /workspaces/rails-api-getting-starte-gcp/
...
# final destination at /workspaces/rails-api-getting-starte-gcp:
COPY --from=builder --chown=nobody:nogroup /workspaces/rails-api-getting-starte-gcp /workspaces/rails-api-getting-starte-gcp

# Set the container user to 'nobody':
USER nobody

# Set the RAILS and PORT default values:
ENV HOME=/workspaces/rails-api-getting-starte-gcp \
...
ENTRYPOINT [ "/workspaces/rails-api-getting-starte-gcp/bin/entrypoint" ]
